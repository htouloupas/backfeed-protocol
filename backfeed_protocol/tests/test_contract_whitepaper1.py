...
class WhitePaper1ContractTest(BaseContractTestCase):
    ...
    def test_sanity(self,):
        ...
        contract.create_evaluation(
            user=evaluator1, contribution=contribution, value=True)
        ...
        contract.create_evaluation(
            user=evaluator2, contribution=contribution, value=False)
        # on the third evaluation, some rep should flow to evaluator1
        contract.create_evaluation(
            user=evaluator3, contribution=contribution, value=True)
